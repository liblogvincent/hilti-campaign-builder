...
describe("adaptPlanWithRepair", () => {
  ...
  it("returns the plan on first success", async () => {
    ...
    const r = await adaptPlanWithRepair("b", { id: "paid-media-launch", version: "1.4.0" }, { id: "paid-media-launch", version: "1.4.0" } as any);
  ...
  it("throws after maxRetries exhausted", async () => {
    ...
    await expect(
      adaptPlanWithRepair("b", { id: "paid-media-launch", version: "1.4.0" }, { id: "paid-media-launch", version: "1.4.0" } as any, 1),
